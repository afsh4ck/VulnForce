...
export const vulnerabilities: Vulnerability[] = [
    ...
    },
    {
      ...
      technicalDescription_es: "### Descripción Técnica\nServicios como RDP, SMB o puertos de gestión de bases de datos están abiertos a Internet. Un atacante puede dirigirse directamente a estos servicios para encontrarulnerabilidades, forzar credenciales o lanzar ataques de denegación de servicio.",
