...
export const initialClients: Client[] = [
  ...
  { id: 'cli-h4ck', name: 'h4ckercademy', contact: 'info@h4ckercademy.com', phone: '+1-202-555-0182', logoUrl: CLIENT_LOGOS['cli-h4ck'] },
  { id: 'cli-trilocor', name: 'Trilocor Robotics', contact: 'security@trilocor-robotics.com', phone: '+1-202-555-0184', logoUrl: '' },
];
